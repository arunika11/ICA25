        ...
        >
          <div className="min-h-screen flex items-center">
            <div className="mx-4 mt-28 sm:mx-8 lg:ml-20 lg:mt-44 w-full">
              ...
              >
                Jointly Organized by IIT Guwahati, NIT Arunachal and AWaDH, IIT
                Ropar
              </div>
              ...
              <div className="flex flex-col lg:flex-row mt-8 sm:mt-16 w-full justify-between items-start lg:items-center px-4 lg:px-10">
                ...
                <div className="flex flex-col space-y-8">
                  <div className="flex mx-auto space-x-4 mt-6 lg:mt-0 mr-10">
                    ...
                    <a
                      target="_blank"
                      href="https://docs.google.com/forms/d/e/1FAIpQLSf81VV1MbLWIKFMvIV6dblkKipoaL4GcfrleD1p-Kxl0FuogQ/viewform?usp=sharing"
                    >
        ...
        <div className="lg:w-1/2 space-y-6 mx-auto">
          ...
          <p className=" font-body text-lg leading-relaxed text-gray-700">
            ...
            <a
              ...
              href="https://link.springer.com/book/10.1007/978-3-031-43605-5"
            >
              {" "}
              Proceeding link{" "}
            </a>
            ...
            <a
              className="text-blue-600 font-medium"
              href="https://link.springer.com/book/9783031744396"
            >
              {" "}
              Proceeding link
            </a>
            ), this conference provides a vibrant platform for researchers at
            the intersection of agriculture and computing to share
            groundbreaking innovations. We welcome original contributions in
            areas such as IoT, Precision Agriculture, Crop Yield Prediction,
