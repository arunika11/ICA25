      ...
      <div>
        <div className="min-h-screen font-sans overflow-hidden">
          <section
            ...
            style={{
              backgroundImage: `url('${IMAGE_PREFIX}agriculture-bg.jpg')`,
            }}
          >
            <div className="min-h-screen flex items-center">
                ...
                <div className="flex flex-col lg:flex-row mt-8 sm:mt-16 w-full justify-between items-start lg:items-center px-4 lg:px-10">
                  ...
                  <div className="flex flex-col space-y-8">
                    <div className="flex mx-auto space-x-4 mt-6 lg:mt-0 mr-10">
                      ...
                      <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSf81VV1MbLWIKFMvIV6dblkKipoaL4GcfrleD1p-Kxl0FuogQ/viewform?usp=sharing">
                        <button className="font-body px-6 sm:px-4 py-2 border border-[#fff] text-white font-medium hover:bg-[#4ECB38] hover:text-black transition">
              ...
              mr-0 md:mr-5 lg:mr-10"
                    >
                      <h1
                        className="text-white mx-auto font-medium 
        ...
        <div className="flex flex-col lg:flex-row items-center mt-28 lg:items-start justify-between p-6 lg:p-16 min-h-[90vh]">
          <div className="lg:w-1/2 space-y-6 mx-auto">
            ...
            <p className=" font-body text-lg leading-relaxed text-gray-700">
              ...
              IIT Ropar (2023,
              <a className="text-blue-600 font-medium" href="https://link.springer.com/book/10.1007/978-3-031-43605-5">
                {" "}
                Proceeding link{" "}
              </a>
              ) and IIIT Delhi (2024,
              <a className="text-blue-600 font-medium" href="https://link.springer.com/book/9783031744396">
                {" "}
                Proceeding link
              </a>
              ), this conference provides a vibrant platform for researchers at
              the intersection of agriculture and computing to share groundbreaking
              innovations. We welcome original contributions in areas such as IoT,
              Precision Agriculture, Crop Yield Prediction, Remote Sensing,
              Agricultural Datasets, and AI/ML applications in agriculture. Accepted
              papers will be published in the Springer CCIS book series, ensuring
              global reach and impact. Join us at ICA 2025 as we continue fostering
              cutting-edge discussions and advancing the field of agriculture-centric
              computation.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-between mt-16">
            <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
              ...
              <p className="font-body text-lg leading-relaxed text-gray-300 mt-2">
                Explore how AI and ML are transforming agriculture by enabling smarter
                crop predictions, pest control, and optimized resource use, driving
            ...
            <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
              ...
              <p className=" font-body text-lg leading-relaxed text-gray-300 mt-2">
                Discover the power of remote sensing in agriculture, leveraging satellite
                imagery, drones, and sensors to monitor crops, assess soil health, and manage
            ...
            <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
              ...
              <p className=" font-body text-lg leading-relaxed text-gray-300 mt-2">
                Delve into precision agriculture technologies like GPS, IoT, and robotics,
                offering data-driven solutions for efficient farming, higher yields, and
            ...
            <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
              ...
              <p className="text-lg leading-relaxed text-gray-300 mt-2">
                Uncover how IoT is revolutionizing agriculture with smart devices and sensors,
                enabling real-time monitoring, automated systems, and intelligent farm management.
              </p>
            </div>
          </div>
        </div>
